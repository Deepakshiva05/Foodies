      ...
      <div className="container pt-5">
        <div className="row d-flex justify-center items-center">
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 text-white font-rich">
                ...
                <p className='font-rich leading-tight'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea eos sed odit, modi, cum nostrum aliquid non est asperiores enim deserunt ipsa ut officiis inventore? Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis reprehenderit quidem nam.</p><br />
               <div className="btns">
